...
public class ModelTableauAjoutRpSp extends AbstractTableModel {
  ...
  /** Modèle pour l'ajout d'une réponse pour un sportif en particulier.
  * @param sp Sportif à qui on ajoute les réponses.
  * @param indxListeQa index de la selection dans la JCheckBox
  */
  ...
  /** Permet la construction du tableau de questions/réponses.
  ...
  */
  ...
  public void setValueAt(Object value, int rowIndex, int columnIndex) {
    if (value != null) {
      switch (columnIndex) {
        case 1:
          this.questionnaire.getquListe().get(rowIndex).setChoixDeflt((Boolean)value);
          break;
        default:
          break;
      }
